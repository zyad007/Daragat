...
export default function DenseTable6({ rows, headers }) {
  ...
  <TableContainer sx={{ maxHeight: 670 }}>
    <Table stickyHeader aria-label="sticky table">
      ...
      <TableRow>
            ...
            <TableCell sx={{ width: 150 }} align="center" onClick={(e) => {
              sortBy("SUB5");
            }}><Button variant='text'><strong>{sort.prop === "SUB5" && (sort.order ? <FontAwesomeIcon icon={faSortUp} /> : <FontAwesomeIcon icon={faSortDown} />)} {headers ? headers.subject5 : 'Subject 5'}</strong></Button></TableCell>
            <TableCell sx={{ width: 150 }} align="center" onClick={(e) => {
              sortBy("SUB6");
            }}><Button variant='text'><strong>{sort.prop === "SUB6" && (sort.order ? <FontAwesomeIcon icon={faSortUp} /> : <FontAwesomeIcon icon={faSortDown} />)} {headers ? headers.subject6 : 'Subject 6'}</strong></Button></TableCell>
      ...
      {rows.map((row, index) => (
            ...
            >
              ...
              <TableCell align="center"><strong>{row.subject5}</strong></TableCell>
              <TableCell align="center"><strong>{row.subject6}</strong></TableCell>
